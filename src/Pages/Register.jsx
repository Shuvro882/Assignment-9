          ...
          <div className="card-body">
            <fieldset className="fieldset">
              ...
              <input
                ...
                placeholder="Email"
              />
              <label className="label text-green-800 font-semibold">PhotoUrl</label>
              <input
                type="email"
                className="input input-bordered border-green-300 focus:border-green-500"
                placeholder="Email"
              ...
              <p className='font-semibold text-center'>All Ready Have An Account ? <Link className='text-secondary' to={"/Login"} >Login</Link></p>
            </fieldset>
          </div>
        </div>
      </div>
